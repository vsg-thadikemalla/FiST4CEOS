The FiST4CEOS.exe file, available in the for_testing folder, launches the MATLAB-based tool (GUI) capable of processing CEOS-formatted EOS-04 SLC data acquired in FRS mode.
